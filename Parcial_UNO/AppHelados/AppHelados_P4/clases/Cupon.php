...
class Cupon
{
    ...
    public static function UsarEnBd($cupon, $importeFinal, $descuento)
    {
        ...
        finally
        {
            ...
            GrabarLeerJson::GrabarEnJson($array, 'cupon.json');
            return $retorno;
        }     
    }
    ...
    public static function Imprimir($item) //borrar este comment si lo uso
    {
        ...
        $usado = Herramientas::SacarValorDeClave($item, "usado");
        $descuento = Herramientas::SacarValorDeClave($item, "descuento");
        $importeFinal = Herramientas::SacarValorDeClave($item, "importeFinal");
