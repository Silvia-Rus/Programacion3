...
class Venta
{
    ...
    public function CalcularPrecio($arrayProductos, $idCupon = null)
    {
        ...
        if($idCupon != null)
        {
            $cupon = AccesoDatos::retornarObjeto($idCupon, 'cupon', 'Cupon');

            if($cupon != null && $cupon[0]->usado == 0)
            {            
               
                $descuento = $retorno * 0.1;   
                $retorno = $retorno - $descuento;
                Cupon::UsarEnBd($cupon[0], $retorno, $descuento);
    ...
    public function Alta($usuario, $producto, $arrayProductos, $rutaProductos, $cupon = null)
    {
        ...
        else
        {
            ...
            //var_dump($this);
            $this->_precio = $this->CalcularPrecio($arrayProductos, $cupon);
    ...
    {     
        ...
        $mailUsuario = Herramientas::SacarValorDeClave($usuario, "_email");
    ...
    {             
        ...
        $arrayProductos = GrabarLeerJson::LeerJson("heladeria.json");
        ...
        if($indice > -1)
        {
            ...
            if($hayStock)
            {
                ...
                $precio = $arrayProductos[$indice]["_precio"] * $cantidad;
                
                if(Venta::ModificarEnBd($numeroPedido, $idUsuario, $idProducto, $cantidad, $precio))
                {
    ...
    public static function ModificarEnBd($numeroPedido, $idUsuario, $idProducto, $cantidad, $precio)
    {
        $retorno = false;
        try
        {
